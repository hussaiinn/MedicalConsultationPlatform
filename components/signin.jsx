        ...
        <>
            <div className="form-container sign-in-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="email" placeholder="Email" value={loginDetails.email} onChange={handleFormData} name='email' required />
                    <input type="password" placeholder="Password" value={loginDetails.password} onChange={handleFormData} name='password' required />
