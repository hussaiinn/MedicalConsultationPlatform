...
const HeadSix = () => {
    return (
        <>
            <h1 className="prf-us">INTRODUCING</h1>
            <h1 className="sprf-us">OUR PROFESSIONALS</h1>
        </>
    );
}
            ...
            <div className="container-6">
                <div className="our-team">
                    ...
                    <div className="team-content">
                        ...
                        <h4 className="title">
                            He completed his education at AIIMS Bhopal and has been practicing
                            as a doctor for the past three years.
                        </h4>
                    </div>
                    <ul className="social">
                        <li>
